...
<form id="survey-form" method="post" action="/user/authenticate">
    ...
    <fieldset>
        <label id="email-label" for="email">Email
            <input name="email" type="email" class="form-control" placeholder="Enter your email" required value="<?php echo e(old('email')); ?>"/>
        </label>
        <label id="password-label" for="password">Password
            <input name="password" type="password" class="form-control" placeholder="Enter your password" required value=""/>
